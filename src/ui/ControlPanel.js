...
export const ControlPanel = () => {
    const { engine, snapshot, selectedTower, setSelectedTower, setStatusMessage, setActiveTowerId, setActiveTerrain, gameSpeed, setGameSpeed, gameSpeedOptions, phase } = useGame();
