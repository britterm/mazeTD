...
import bruteSpriteUrl from '../../../assets/sprites/enemies/brute/spritesheet_96x96_6x6.png';

export type BruteSpriteSheet = CrawlerSpriteSheet;
...
export const createBruteSpriteSheet = (): BruteSpriteSheet | null => {
  if (typeof Image === 'undefined') {
    return null;
  }

  const image = new Image();
  image.src = bruteSpriteUrl;
